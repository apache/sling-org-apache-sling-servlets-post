...
public class JavaxToJakartaNodeNameGenerator implements JakartaNodeNameGenerator {
    ...
    @Override
    public String getNodeName(final SlingJakartaHttpServletRequest request,
        ...
        final NodeNameGenerator dng = new NodeNameGenerator() {
            @Override
            public String getNodeName(final SlingHttpServletRequest internalRequest,
                    final String internalParentPath,
                    final boolean internalRequirePrefix,
                    final NodeNameGenerator defaultInternalGenerator) {
                return defaultNodeNameGenerator.getNodeName(request, internalParentPath, internalRequirePrefix, defaultNodeNameGenerator);
            }
        };
        return this.delegate.getNodeName(JakartaToJavaxRequestWrapper.toJavaxRequest(request), parentPath, requirePrefix, dng);
    }
}
