...
public class JakartaToJavaxPostProcessor implements SlingPostProcessor {
    ...
    public JakartaToJavaxPostProcessor(final SlingJakartaPostProcessor delegate) {
        this.delegate = delegate;
    }

    @Override
    public void process(final SlingHttpServletRequest request, final List<Modification> changes) throws Exception {
        this.delegate.process(JavaxToJakartaRequestWrapper.toJakartaRequest(request), changes);
    }
}
